...
Config.leader_group_clues = {
  ...
  { mode = 'n', keys = '<Leader>t', desc = '+Terminal/Tab' },
...
nmap_leader('frf', '<Cmd>FzfLua files resume=true<CR>',                       'Resume files')
...
nmap_leader('gg', '<Cmd>G<CR>',  'Toggle Fugitive')
nmap_leader('gb', '<Cmd>G blame<CR>',  'Git blame')
nmap_leader('gll', '<Cmd>G log<CR>',  'Git log')
nmap_leader('glc', '<Cmd>Gclog<CR>',  'Gclog')
nmap_leader('ghf', '<Cmd>0Gclog<CR>',  'FileHistory Fugitive')
nmap_leader('ghd', '<Cmd>DiffviewFileHistory %<CR>',  'FileHistory Diffview')
nmap_leader('gd', '<Cmd>Gdiffsplit<CR>',  'Git diffsplit')
nmap_leader('gcc', '<Cmd>G commit<CR>',  'Git commit')
nmap_leader('gca', '<Cmd>G commit --amend<CR>',  'Git commit --amend')
nmap_leader('gpp', '<Cmd>G push<CR>',  'Git push')
nmap_leader('gpf', '<Cmd>G push --force-with-lease<CR>',  'Git push --force-with-lease')
nmap_leader('gG', '<Cmd>LazyGit<CR>',  'Toggle Lazygit')
nmap_leader('gL', function () require('gitlab').review() end,  'Toggle GitLab')
--
...
-- nmap_leader('gd', '<Cmd>lua vim.lsp.buf.definition()<CR>',      'Source definition')
...
nmap_leader('tc', '<Cmd>tabclose<CR>',   'Tab close')
nmap_leader('tn', '<Cmd>tabnew<CR>',   'Teb new')
